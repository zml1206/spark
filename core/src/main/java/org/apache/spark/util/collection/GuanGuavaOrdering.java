 ...
 */
@GwtCompatible
public abstract class GuanGuavaOrdering<T> implements Comparator<T> {
    // Natural order
...
//    public static <C extends Comparable> com.google.common.collect.Ordering<C> natural() {
//        return (com.google.common.collect.Ordering<C>) NaturalOrdering.INSTANCE;
//    }
//
//    // Static factories
//
...
//     */
//    @GwtCompatible(serializable = true)
//    public static <T> com.google.common.collect.Ordering<T> from(Comparator<T> comparator) {
//        return (comparator instanceof com.google.common.collect.Ordering)
//                ? (com.google.common.collect.Ordering<T>) comparator
...
//     */
//    @GwtCompatible(serializable = true)
//    @Deprecated public static <T> com.google.common.collect.Ordering<T> from(com.google.common.collect.Ordering<T> ordering) {
...
//     */
//    @GwtCompatible(serializable = true)
//    public static <T> com.google.common.collect.Ordering<T> explicit(List<T> valuesInOrder) {
...
//     */
//    @GwtCompatible(serializable = true)
//    public static <T> com.google.common.collect.Ordering<T> explicit(
...
//    public static com.google.common.collect.Ordering<Object> allEqual() {
...
//     */
//    @GwtCompatible(serializable = true)
//    public static com.google.common.collect.Ordering<Object> usingToString() {
...
//     * @since 2.0
//     */
//    public static com.google.common.collect.Ordering<Object> arbitrary() {
//        return com.google.common.collect.Ordering.ArbitraryOrderingHolder.ARBITRARY_ORDERING;
//    }
//
//    private static class ArbitraryOrderingHolder {
//        static final com.google.common.collect.Ordering<Object> ARBITRARY_ORDERING = new com.google.common.collect.Ordering.ArbitraryOrdering();
//    }
//
//    @VisibleForTesting
//    static class ArbitraryOrdering extends com.google.common.collect.Ordering<Object> {
...
//     */
//    @GwtCompatible(serializable = true)
//    public <F> com.google.common.collect.Ordering<F> onResultOf(Function<F, ? extends T> function) {
...
//     * is equivalent to one created using {@link com.google.common.collect.Ordering#compound(Iterable)} on
//     * the same component comparators.
//     */
//    @GwtCompatible(serializable = true)
//    public <U extends T> com.google.common.collect.Ordering<U> compound(
...
//     */
//    @GwtCompatible(serializable = true)
//    public static <T> com.google.common.collect.Ordering<T> compound(
...
//    public <S extends T> com.google.common.collect.Ordering<Iterable<S>> lexicographical() {
//        /*
