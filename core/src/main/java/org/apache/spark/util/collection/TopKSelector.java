...
//        return least(k, GuanGuavaOrdering.natural());
//    }
//
//    /**
...
//        return greatest(k, GuanGuavaOrdering.natural());
//    }
...
//        return new TopKSelector<T>(GuanGuavaOrdering.from(comparator).reverse(), k);
//    }
